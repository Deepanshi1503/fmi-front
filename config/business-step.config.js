...
import CompanyOverview from "@/components/investor-profile-creation/company-details/steps";
import FounderTeam from "../components/investor-profile-creation/founder-team-details/steps"

const businessStepsConfig = [
    { id: "company-detail", label: "Company Detail", component: <CompanyOverview /> },
