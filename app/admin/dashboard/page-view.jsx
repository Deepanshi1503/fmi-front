...
const DashboardPageView = ({ trans }) => {
  ...
  useEffect(() => {
    const fetchEnrollmentBarStats = async (selectedYear) => {
      ...
      try {
        const response = await axiosInstance.get(`/api/dashboard/enrollmentBarStats?year=${selectedYear}`);
                    ...
                    <div className="col-span-12 lg:col-span-4">
                      <Card>
                        <CardContent className="p-3 grid grid-cols-12 gap-4">
                          <div className=" col-span-12 lg:col-span-4">
                            <Image src={`http://localhost:1337${trainerData?.trainer?.profileImage?.url}`} alt="user" className="rounded-md" width={80}
                              height={40} />
                          </div>
                          <div className="col-span-12 lg:col-span-8">
