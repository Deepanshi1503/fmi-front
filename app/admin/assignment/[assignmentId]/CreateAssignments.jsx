  ...
  const fetchAssignments = async () => {
    try {
      ...
      const { data } = await axiosInstance({
        url: `/api/assignments/${params.assignmentId}?populate=*`,
        method: 'GET',
      })
        ...
        <div>
          {isLoading ?
            ...
            : <div className="grid grid-cols-12">
              ...
              {activeStep === 2 && <AssignmentFinalizingSetting assignment={assignment} handleNext={handleNext} handleBack={handleBack} />}
