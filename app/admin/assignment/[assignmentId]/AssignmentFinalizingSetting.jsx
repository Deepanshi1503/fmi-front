        ...
        startTransition(async () => {
            try {
                await axiosInstance({
                    ...
                    method: 'PUT',
                    data: { data: { ...form, time_limits: hmsToMinutes(form.time_limits) } },
                })
                        ...
                        <div className="grid grid-cols-12 gap-7 p-6">
                            ...
                            <div className="col-span-12 lg:col-span-12">
                                <div className="space-y-2">
                                    ...
                                    <Input type="number" placeholder="Maximum Score" className="rounded-sm h-14 text-base text-default-700" {...register("valid_attempts", {
