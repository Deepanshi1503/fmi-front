...
export default function RightImageWithContent() {
    return (
        <section className='left-image-with-content-main padding3'>
            <div className='container'>
                <div className='flex lg:flex-row flex-col-reverse w-full overflow-hidden rounded-[20px]'>
                    <div className='lg:w-1/2 md:w-full xl:p-12 sm:p-8 p-8  flex flex-column justify-center bg-[#F9F8F6]'>
