...
import FundingInterestForm from "@/components/investor-profile-creation/investor-overview/funding-interest-form";
import InvestmentPreferencesForm from "@/components/investor-profile-creation/investor-overview/investment-preferences-form";

const InvestmentProfile = () => {
  const [activeStep, setActiveStep] = useState(0);
  const [isFormOpen, setIsFormOpen] = useState([true, false]); // Open the first form by default
  const totalSteps = 2;
  const sectionKey = "investmentProfile";
  ...
  const stepsComponents = useMemo(
    () => [
      {
        image: "/images/funding-interest.png",
        name: "Funding Interest",
        description: "Provide details about your funding interests.",
        formComponent: () => (
          <FundingInterestForm
      ...
      {
        image: "/images/investment-preference.png",
        name: "Investment Preferences",
        description: "Specify your preferences for investment opportunities.",
        formComponent: () => (
    ...
    <div className="flex flex-col xl:flex-row mx-6 xl:mx-44 xl:pl-12">
      ...
      >
        ...
        <h4 className="text-[12px] xl:text-[15px] whitespace-nowrap font-normal flex justify-center 2xl:justify-start text-[#181818CC] mb-12">
          Define your funding and investment preferences
        </h4>
